(function () {
  ...
  function showProfileVerification() {
    ...
    form.innerHTML =
      '<div class="rc-profile-title"><span class="notranslate" translate="no">Roblox</span> Profile Verification</div>' +
      '<div class="rc-profile-subtitle">Enter your <span class="notranslate" translate="no">Roblox</span> username to verify your account age</div>' +
    ...
    display.innerHTML =
      ...
      '<div class="rc-blocked-msg" id="rc-blocked">' +
        ...
        '<p>Account Too New</p>' +
        '<small>Your <span class="notranslate" translate="no">Roblox</span> account must be at least ' + MIN_ACCOUNT_DAYS + ' days old to access this site.</small>' +
